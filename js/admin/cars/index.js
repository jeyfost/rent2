                                                        ...
                                                        if(days_3_10 !== "") {
                                                            if(days_10_20 !== "") {
                                                                if(days_20_30 !== "") {
                                                                    ...
                                                                    $.notify("Вы не ввели стоимость аренды за 20-30 дней.", "error");
                                                                }
                                                            } else {
                                                                $.notify("Вы не ввели стоимость аренды за 10-20 дней.", "error");
                                                            }
                                                        } else {
                                                            $.notify("Вы не ввели стоимость аренды за 3-10 дней.", "error");
                                                        }
                                                    } else {
                                                        $.notify("Вы не ввели стоимость аренды за 2 дня.", "error");
                                                    }
                                                } else {
                                                    $.notify("Вы не ввели стоимость аренды за 1 день.", "error");
                                                }
                                            } else {
